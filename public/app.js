...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  // src/PasswordView.tsx
  var React3 = __toESM(require_react());

  // src/passwords.ts
  var PASSWORD_1 = "adb0c3e070c72b6adeaf8021da88d77f856165e7e45d497eb57ca4ad3d63e35";
  var PASSWORD_2 = "67ecf8cd93f2c86c8f66c69c9811af59d7e3e12b5e7db6b9462bc2aba26";
  var hashString = async (source) => {
  ...
  var Input = (props) => /* @__PURE__ */ React2.createElement(
    "input",
    {
      ...props,
  ...
  var PasswordView = ({ setPage }) => {
    ...
    const checkPassword = React3.useCallback(async () => {
    ...
    return /* @__PURE__ */ React3.createElement(React3.Fragment, null, /* @__PURE__ */ React3.createElement("div", null, /* @__PURE__ */ React3.createElement("span", null, "Please enter the password found on your invitation.")), /* @__PURE__ */ React3.createElement("div", { className: "my-2" }, /* @__PURE__ */ React3.createElement(
      Input,
      {
        className: "w-full",
    ...
    )), /* @__PURE__ */ React3.createElement("div", { className: "flex" }, /* @__PURE__ */ React3.createElement(Button, { onClick: checkPassword }, "Join the festivities!")));
  };
  ...
  // src/emails.ts
  var OLD_API_KEY = "bqj;g35gf8f86c1:1ecbd8d8ccfb8:cf5:ce.c13cdg:g.3556516e";
  var NEW_API_KEY = OLD_API_KEY.split("").map((char) => String.fromCharCode(char.charCodeAt(0) - 1)).join("");
  var DOMAIN = "sandbox12a40535aa9a441aa75e3a5f9974d777.mailgun.org";
  var sendEmail = (emailInfo) => {
  ...
  var Label = (props) => /* @__PURE__ */ React4.createElement("label", { className: "mb-1 mt-4", ...props });

  // src/Section.tsx
  var Section = ({ children, label }) => /* @__PURE__ */ React5.createElement("div", { className: "flex flex-col" }, /* @__PURE__ */ React5.createElement(Label, null, label), children);
  ...
  var RsvpForm = ({
    ...
    const [attending, setAttending] = React6.useState(null);
    const [clickedAttending, setClickedAttending] = React6.useState(false);
    const [anythingElse, setAnythingElse] = React6.useState("");
    const [attendingInfo, setAttendingInfo] = React6.useState({
      mainEventCount: "",
      sideEventCount: "",
      foodRestrictions: "",
      hotelInfo: isPassword2 ? "" : null
    });
    const [oops, setOops] = React6.useState(false);
    const disabledMessage = React6.useMemo(() => {
      if (name.length < 3) {
    ...
    const updateAttendingInfo = React6.useCallback(
      (key, value) => {
        setAttendingInfo((attendingInfo2) => ({ ...attendingInfo2, [key]: value }));
      },
      []
    );
    const handleAnythingElseChange = React6.useCallback(
      (event) => {
        setAnythingElse(event.currentTarget.value);
      },
      []
    );
    const handleNameChange = React6.useCallback(
      (event) => {
        setName(event.currentTarget.value);
      },
      []
    );
    const handleClickAttending = React6.useCallback(() => {
      setAttending(true);
      setClickedAttending(true);
    }, []);
    const handleClickNotAttending = React6.useCallback(() => {
      setAttending(false);
    }, []);
    const handleChangeMainEventCount = React6.useCallback(
      (event) => {
        updateAttendingInfo("mainEventCount", event.currentTarget.value);
      },
      [updateAttendingInfo]
    );
    const handleChangeSideEventCount = React6.useCallback(
      (event) => {
        updateAttendingInfo("sideEventCount", event.currentTarget.value);
      },
      [updateAttendingInfo]
    );
    const handleChangeFoodRestrictions = React6.useCallback(
      (event) => {
        updateAttendingInfo("foodRestrictions", event.currentTarget.value);
      },
      [updateAttendingInfo]
    );
    const handleChangeHotelInfo = React6.useCallback(
      (event) => {
        updateAttendingInfo("hotelInfo", event.currentTarget.value);
      },
      [updateAttendingInfo]
    );
    const submitRsvp = React6.useCallback(async () => {
      if (attending === null) {
        return;
      }
    ...
    const animationClassName = React6.useMemo(() => {
      if (attending) {
    ...
    return /* @__PURE__ */ React6.createElement("div", null, oops && /* @__PURE__ */ React6.createElement("span", { className: "mt-1 text-red-500" }, "Oops! Something went wrong! Sorry about that. Try again or just reach out to us another way"), /* @__PURE__ */ React6.createElement(Section, { label: "Who are you?" }, /* @__PURE__ */ React6.createElement(Input, { value: name, onChange: handleNameChange })), /* @__PURE__ */ React6.createElement(
      Section,
      {
        label: `Are you attending? ${attending === true ? "\u{1F604}" : attending === false ? "\u{1F615}" : "\u{1F440}"}`
      },
      /* @__PURE__ */ React6.createElement("div", { className: "flex justify-evenly" }, /* @__PURE__ */ React6.createElement("div", { className: "flex gap-2 items-center" }, /* @__PURE__ */ React6.createElement("label", { htmlFor: "attending-yes", className: "font-light" }, "Yes!"), /* @__PURE__ */ React6.createElement(
        Input,
        {
          id: "attending-yes",
      ...
      )), /* @__PURE__ */ React6.createElement("div", { className: "flex gap-1 items-center" }, /* @__PURE__ */ React6.createElement("label", { htmlFor: "attending-no", className: "font-light" }, "No"), /* @__PURE__ */ React6.createElement(
        Input,
        {
          id: "attending-no",
    ...
    )), /* @__PURE__ */ React6.createElement(Section, { label: "Do you have any dietary restrictions?" }, /* @__PURE__ */ React6.createElement(
      Input,
      {
  ...
  var Header = ({ children }) => /* @__PURE__ */ React7.createElement("h1", { className: "text-xl font-bold mt-3" }, children);
  ...
  var InfoView = ({ rsvped, onClickRsvp }) => {
    return /* @__PURE__ */ React9.createElement("div", { className: "flex flex-col" }, rsvped && /* @__PURE__ */ React9.createElement("span", { className: "text-green-700 mt-1" }, "Thanks for RSVPing!"), /* @__PURE__ */ React9.createElement(Header, null, "Schedule"), /* @__PURE__ */ React9.createElement("div", null, /* @__PURE__ */ React9.createElement("h1", { className: "font-bold mt-3" }, "Wedding Ceremony + Reception"), "Sunday, July 21, 2024 | 6:00 PM", /* @__PURE__ */ React9.createElement("br", null), /* @__PURE__ */ React9.createElement(Link, { href: "https://kymarestaurants.com" }, "Kyma Restaurant"), " |", " ", /* @__PURE__ */ React9.createElement(Link, { href: "https://maps.app.goo.gl/yFkPUBM6ZLpSfmqC7" }, " ", "15 West 18th Street, New York, NY"), /* @__PURE__ */ React9.createElement("br", null), "Expect a night of ceremony, socializing, food, and board games!", /* @__PURE__ */ React9.createElement("br", null), "Semi-formal attire.", /* @__PURE__ */ React9.createElement("br", null), "We're so grateful to you for celebrating with us! Your presence is truly enough; we kindly request no gifts."), /* @__PURE__ */ React9.createElement("div", null, /* @__PURE__ */ React9.createElement("h1", { className: "font-bold mt-3" }, "Scavenger Hunt"), "Saturday, July 20, 2024 | 4:30 PM", /* @__PURE__ */ React9.createElement("br", null), "Meeting location:", " ", /* @__PURE__ */ React9.createElement(Link, { href: "https://maps.app.goo.gl/wD47Ckz4tsVVmFM3A" }, "Pulitzer Fountain, 764 Central Park S, New York, NY"), /* @__PURE__ */ React9.createElement("br", null), "For those who will be in town, we'll be hosting a private", " ", /* @__PURE__ */ React9.createElement(Link, { href: "https://secretcityny.com/central-park-scavenger-hunt" }, "scavenger hunt in Central Park"), ".", /* @__PURE__ */ React9.createElement("br", null), "If you won't be in town yet or this just isn't your thing, that's absolutely fine! No pressure to attend.", /* @__PURE__ */ React9.createElement("br", null), "Dress comfortably! Food to follow."), /* @__PURE__ */ React9.createElement("div", null, /* @__PURE__ */ React9.createElement(Header, null, "Hotel Options"), "We have group rates available for the nights of July 20 and 21 at:", /* @__PURE__ */ React9.createElement("br", null), "\u2022", " ", /* @__PURE__ */ React9.createElement(Link, { href: "https://www.marriott.com/event-reservations/reservation-link.mi?id=1706712016894&key=GRP&app=resvlink" }, "SpringHill Suites Chelsea"), /* @__PURE__ */ React9.createElement("br", null), "\u2022", " ", /* @__PURE__ */ React9.createElement(Link, { href: "https://www.marriott.com/event-reservations/reservation-link.mi?id=1706284733030&key=GRP&app=resvlink" }, "Renaissance New York Chelsea Hotel"), /* @__PURE__ */ React9.createElement("br", null), "\u2022", " ", /* @__PURE__ */ React9.createElement(Link, { href: "https://www.marriott.com/event-reservations/reservation-link.mi?id=1707740788443&key=GRP&app=resvlink" }, "Moxy NYC Chelsea"), /* @__PURE__ */ React9.createElement("br", null), "Click those links to book your room using our group rate by June 15.", /* @__PURE__ */ React9.createElement("br", null), "There's a limited number of rooms available but we can add more, so reach out to us if the groups have run out of rooms."), /* @__PURE__ */ React9.createElement("div", null, /* @__PURE__ */ React9.createElement(Header, null, "RSVP"), "We hope that you can join us! Please RSVP by June 1 by clicking here:", /* @__PURE__ */ React9.createElement("br", null), /* @__PURE__ */ React9.createElement("div", { className: "mt-1" }), /* @__PURE__ */ React9.createElement(Button, { onClick: onClickRsvp }, "RSVP")), /* @__PURE__ */ React9.createElement("div", null, /* @__PURE__ */ React9.createElement(Header, null, "Questions?"), "Reach out to Arley at (412) 576-7729 or Alex at (631) 278-1242."));
  };

  // src/MainView.tsx
  var MainView = ({ isPassword2 }) => {
    const [showingRsvp, setShowingRsvp] = React10.useState(false);
    const [rsvped, setRsvped] = React10.useState(false);
    const handleSubmitRsvp = React10.useCallback(() => {
      setRsvped(true);
      setShowingRsvp(false);
    }, []);
    const handleClickRsvp = React10.useCallback(() => {
      setShowingRsvp(true);
    }, []);
    return /* @__PURE__ */ React10.createElement("div", null, /* @__PURE__ */ React10.createElement("h2", { className: "text-xl" }, "\u{1F389} We're so excited to celebrate with you! \u{1F389}"), showingRsvp ? /* @__PURE__ */ React10.createElement(RsvpForm, { isPassword2, onSubmitRsvp: handleSubmitRsvp }) : /* @__PURE__ */ React10.createElement(InfoView, { rsvped, onClickRsvp: handleClickRsvp }));
  };
  ...
  // src/index.tsx
  ReactDOM.render(/* @__PURE__ */ React12.createElement(App, null), document.getElementById("root"));
})();
